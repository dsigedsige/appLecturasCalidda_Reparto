...
namespace DSIGE.Negocio
{
    public class NUbicacion_Lecturas
    {
        ...
        public List<Ubicacion_Lectura> Capa_Negocio_Get_ListaOperariosServicio( int idServicio)
        {
            try
            {
                DUbicacion_Lecturas Objeto_Dato = new DUbicacion_Lecturas();
                return Objeto_Dato.Capa_Dato_Get_ListaOperariosServicios(idServicio);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public List<Ubicacion_Lectura> Capa_Negocio_Get_ListaServicios_reporte(int id_usuario)
        {
            try
            {
                DUbicacion_Lecturas Objeto_Dato = new DUbicacion_Lecturas();
                return Objeto_Dato.Capa_Dato_Get_ListaServicio_reporte(id_usuario);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public List<UbicacionOperario> NSeguimiento_Lecturas_IV(string pFechaAsiga, int servicio, int operario, string suministro, string medidor, string fechaEjecucion , int todosEjecucion)
        {
            try
            {
                return new DUbicacion_Lecturas().DSeguimiento_Lectura_IV(pFechaAsiga, servicio, operario, suministro, medidor, fechaEjecucion, todosEjecucion);
            }
            catch (Exception e)
            {
                throw e;
