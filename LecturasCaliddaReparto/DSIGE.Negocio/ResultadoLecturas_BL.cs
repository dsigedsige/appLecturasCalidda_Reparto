...
namespace DSIGE.Negocio
{
    public class ResultadoLecturas_BL
    {
        ...
        public object Capa_Negocio_ListandoSector()
        {
            try
            {
                Cls_Dato_ResultadoLecturas Objeto_Dato = new Cls_Dato_ResultadoLecturas();
                return Objeto_Dato.Capa_Dato_Get_ListaSectores();
            }
            catch (Exception e)
            {
                throw e;
        ...
        public List<ResultadoLecturas_E> Capa_Negocio_Get_ListaResumenReparto(string FechaAsignacion, int id_tiposervicio, int id_sector)
        {
            try
            {
                Cls_Dato_ResultadoLecturas Objeto_Dato = new Cls_Dato_ResultadoLecturas();
                return Objeto_Dato.Capa_Dato_Get_ListaResumenReparto(FechaAsignacion, id_tiposervicio, id_sector);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public List<ResultadoLecturas_E> Capa_Negocio_ListandoResumenReparto_Detallado(string FechaAsignacion, int id_tiposervicio, int id_sector)
        {
            try
            {
                Cls_Dato_ResultadoLecturas Objeto_Dato = new Cls_Dato_ResultadoLecturas();
                return Objeto_Dato.Capa_Dato_ListandoResumenReparto_Detallado(FechaAsignacion, id_tiposervicio, id_sector);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_ListandoResumenReparto_Detallado_New(string FechaAsignacion, int id_tiposervicio, int id_sector)
        {
            try
            {
                Cls_Dato_ResultadoLecturas Objeto_Dato = new Cls_Dato_ResultadoLecturas();
                return Objeto_Dato.Capa_Dato_ListandoResumenReparto_Detallado_New(FechaAsignacion, id_tiposervicio, id_sector);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_ListandoResumenReparto_Detallado_New2(string FechaAsignacion, int id_tiposervicio, int id_sector)
        {
            try
            {
                Cls_Dato_ResultadoLecturas Objeto_Dato = new Cls_Dato_ResultadoLecturas();
                return Objeto_Dato.Capa_Dato_ListandoResumenReparto_Detallado_New2(FechaAsignacion, id_tiposervicio, id_sector);
            }
            catch (Exception e)
            {
                throw e;
