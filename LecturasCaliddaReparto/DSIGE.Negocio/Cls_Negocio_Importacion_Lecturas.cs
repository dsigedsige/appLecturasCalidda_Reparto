...
namespace DSIGE.Negocio
{
    public class Cls_Negocio_Importacion_Lecturas
    {
        ...
        /// <returns></returns>
        public List<Cls_Entidad_Lecturas_Relecturas> Capa_Negocio_Agrupado_temporal_lectura(string idfechaAsignacion, int cod_usuario)
        {
            try
            {
                Cls_Dato_Importacion_Lecturas Objeto_Dato = new Cls_Dato_Importacion_Lecturas();
                return Objeto_Dato.Capa_Dato_Agrupado_temporal_lectura(idfechaAsignacion, cod_usuario);
            }
            catch (Exception e)
            {
        ...
        public object Capa_Negocio_Agrupado_temporal_lecturaII(string idfechaAsignacion, int cod_usuario)
        {
            try
            {
                Cls_Dato_Importacion_Lecturas Objeto_Dato = new Cls_Dato_Importacion_Lecturas();
        ...
        public string Capa_Negocio_set_EnviarCorreo_relectura(int servicio, string fecha_Asigna, int usuario)
        {
            try
            {
                string resultado = "";
                Cls_Dato_Importacion_Lecturas Objeto_Dato01 = new Cls_Dato_Importacion_Lecturas();
                resultado = Objeto_Dato01.Capa_Dato_set_EnviarCorreo_Relectura(servicio, fecha_Asigna, usuario);
        ...
        public string Capa_Negocio_save_repartoActualizar(string fechaAsignacion, string fechaMovil, int id_servicio, int usuario)
        {
            try
            {
                List<Cls_Entidad_Lecturas_Relecturas> listaobjeto = new List<Cls_Entidad_Lecturas_Relecturas>();
                string resultado = "";
                Cls_Dato_Importacion_Lecturas Objeto_Dato01 = new Cls_Dato_Importacion_Lecturas();
                resultado = Objeto_Dato01.Capa_Dato_save_repartoActualizar(fechaAsignacion, fechaMovil, usuario);
