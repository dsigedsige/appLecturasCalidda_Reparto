...
namespace DSIGE.Dato
{
    public class DCorte
    {
        ...
        public object  Capa_Dato_ListaExcel_Enel(string fileLocation, int usuario, int idlocal, string idfechaAsignacion, int anio, int mes )
        {
            object resul = null;
            resul res = new resul();
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(cadenaCnx))
                {
                    ...
                    using (SqlBulkCopy bulkCopy = new SqlBulkCopy(con))
                    {
                        ...
                        string Sql = "UPDATE TEMPORAL_REPARTO_ENEL SET  anio ='" + anio + "' , mes ='" + mes + "',   loc_id ='" + idlocal + "' , idUsuarioExport='" + usuario + "', fechaAsignacion='" + idfechaAsignacion + "'  WHERE idUsuarioExport IS NULL   ";
        ...
        public object Capa_Dato_get_datosCargo(int anio, int mes, string sector, int tipoCargo, int usuario)
        {
            DataTable dt_detalle = new DataTable();
            resul res = new resul();
            try
            {
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_S_LISTAR_CARGOS_CAB", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        ...
                        cmd.Parameters.Add("@tipoCargo", SqlDbType.Int).Value = tipoCargo;
                        cmd.Parameters.Add("@usuario", SqlDbType.Int).Value = usuario;
        ...
        public object Capa_Dato_get_datosCargoPDF(string idscargo, int tipoCargo, int usuario)
        {
            DataTable dt_detalle = new DataTable();
            resul res = new resul();
            try
            {
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_S_LISTAR_CARGOS_PDF", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@idscargo", SqlDbType.VarChar).Value = idscargo;
                        cmd.Parameters.Add("@tipoCargo", SqlDbType.Int).Value = tipoCargo;
                        cmd.Parameters.Add("@usuario", SqlDbType.Int).Value = usuario;
